...
public class JSFUtil {
    ...
    */
    ...
    /**
     * Get Session Bean from Context
     * @param elContext
     * @param beanName
     * @param beanClass
     * @return object
     */
    public static Object getSessionBeanFromContext(String beanName,
                                                   Class<?> beanClass) {
        FacesContext ctx = getFacesContext();

        ExpressionFactory ef = ctx.getApplication().getExpressionFactory();
        ValueExpression ve =
            ef.createValueExpression(ctx.getELContext(), beanName, beanClass);
