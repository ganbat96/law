...
public class ADFUtil {
    ...
    /**
     * Find an event binding in the current binding container by name.
     *
     * @param name event binding name
     * @return event binding
     */
    public static JUEventBinding findEventBinding(String name) {
        JUEventBinding event = (JUEventBinding) getDCBindingContainer().get(name);
        if (event == null) {
            throw new RuntimeException("Event Binding '" + name + "' not found");
        }
        return event;
    }
